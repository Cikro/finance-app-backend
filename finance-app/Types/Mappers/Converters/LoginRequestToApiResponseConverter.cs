...
namespace finance_app.Types.Mappers.Converters {
    public class LoginRequestToApiResponseConverter<request, response> :
        ITypeConverter<LoginRequest, ApiResponse<AuthenticationUserDto>>
    {

        public ApiResponse<AuthenticationUserDto> Convert(LoginRequest source, ApiResponse<AuthenticationUserDto> destination, ResolutionContext context) {

...
namespace finance_app.Controllers.V1
{
    ...
    public class TransactionsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetTransactions([FromQuery]UserResourceIdentifier userId, AccountResourceIdentifier accountId,  [FromQuery]GetAccountsRequest request)
        {
